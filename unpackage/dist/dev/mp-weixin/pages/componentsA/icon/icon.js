...
const _sfc_main = {
  ...
  methods: {
    ...
    selectIcon(name) {
      ...
      common_vendor.index.$u.toast("图标名称已复制");
    }
  }
};
if (!Array) {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    a: common_vendor.f($data.iconList, (item, index, i0) => {
      return {
        a: common_vendor.o($options.test, index),
        b: "17a24746-0-" + i0,
        c: common_vendor.p({
          name: item.name,
          size: "30",
        ...
        e: common_vendor.o(($event) => $options.selectIcon(item.name), index),
        f: index
      };
    })
  };
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/project/mini-app/uview-plus/pages/componentsA/icon/icon.nvue"]]);
